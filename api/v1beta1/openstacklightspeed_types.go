...
// OGXSpec defines configuration for the OGX/llama-stack container.
type OGXSpec struct {
	// +kubebuilder:validation:Optional
	// +kubebuilder:default:={requests: {cpu: "500m", memory: "2Gi"}, limits: {cpu: "2", memory: "8Gi"}}
	// Resources sets compute resources for the llama-stack (OGX) container
...
// LightspeedSpec defines configuration for the lightspeed-service-api container.
...
type OpenStackLightspeedCore struct {
	...
	// +kubebuilder:validation:Optional
	// +kubebuilder:default:={}
	// OGX configures the OGX/llama-stack container.
	OGX *OGXSpec `json:"ogx,omitempty"`

	// +kubebuilder:validation:Optional
	// +kubebuilder:default:={}
	// Lightspeed configures the lightspeed-service-api container.
	Lightspeed *LightspeedSpec `json:"lightspeed,omitempty"`
